...
router.get('/quizzes/new', sessionController.loginRequired, upload.single('image'), quizController.new);
...
router.get('/users/:userId(\\d+)/edit', userController.ownershipRequired, userController.edit);     // editar información de cuenta
router.put('/users/:userId(\\d+)',      userController.ownershipRequired, userController.update);   // actualizar información de cuenta
router.delete('/users/:userId(\\d+)',   userController.ownershipRequired, userController.destroy);  // borrar cuenta
